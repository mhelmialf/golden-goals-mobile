...
import 'package:golden_goals/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
  MyHomePage({super.key});

  final String nama = "Muhammad Helmi Alfarissi"; //nama
  final String npm = "2406402416"; //npm
          ...
          children: [
            ...
            Center(
              child: Column(
                ...
                children: [
                  // Teks sambutan diubah agar sesuai konteks
                  const Padding(
...
class ItemHomepage {
  ...
  ItemHomepage(this.name, this.icon, this.color); // Konstruktor diperbarui
}